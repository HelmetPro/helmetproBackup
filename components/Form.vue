<template>
  <section class="text-gray-600 body-font">
    ...
    <div class="container mx-auto bg-white rounded-lg shadow-2xl lg:p-5">
      <div class="lg:flex lg:space-x-10 ">
        ...
        <div class="lg:w-1/2">
          ...
          />
          <div class="py-8 px-5">
            <h1 class="text-3xl lg:text-4xl font-extrabold text-indigo-600 mb-4">Contact Us / Visit Us</h1>
        ...
        <div class="lg:w-1/2 mt-8 lg:mt-0 justify-center items-center  ">
          <span 
            class="block text-2xl font-semibold text-center p-4 ">
            Contact us today for a free consultation!
          </span>
          <div class="lg:mx-10 py-10 lg:py-0 bg-gradient-to-r from-blue-900 to-blue-700  rounded-xl shadow-2xl p-2 lg:p-5">
            <form class="space-y-6 px-5 lg:p-5" @submit.prevent="handleSubmit">
              <div>
              ...
              <div class="text-right my-6">
                <button 
                type="submit" 
                class=" w-full lg:w-1/2 py-5 lg:py-3  text-white bg-orange-500 hover:bg-orange-600 rounded-lg shadow-md transition duration-300" 
                :disabled="isLoading"
              >
